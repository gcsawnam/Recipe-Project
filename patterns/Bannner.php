...
<p class="has-text-align-center has-background-color has-text-color" style="font-size:2rem">
                            <strong>Temperature controlled Cooking.Its in your hands.</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--30)"><!-- wp:button {"backgroundColor":"background","textColor":"foreground","style":{"border":{"radius":"9px"},"typography":{"fontSize":"0.8rem"}}} -->
<div class="wp-block-button has-custom-font-size" style="font-size:0.8rem"><a class="wp-block-button__link has-foreground-color has-background-background-color has-text-color has-background wp-element-button" style="border-radius:9px">Dinner</a></div>
<!-- /wp:button -->

<!-- wp:button {"backgroundColor":"background","textColor":"foreground","style":{"border":{"radius":"9px"},"typography":{"fontSize":"0.8rem"}}} -->
<div class="wp-block-button has-custom-font-size" style="font-size:0.8rem"><a class="wp-block-button__link has-foreground-color has-background-background-color has-text-color has-background wp-element-button" style="border-radius:9px">Snacks</a></div>
<!-- /wp:button -->

<!-- wp:button {"backgroundColor":"background","textColor":"foreground","style":{"border":{"radius":"9px"},"typography":{"fontSize":"0.8rem"}}} -->
<div class="wp-block-button has-custom-font-size" style="font-size:0.8rem"><a class="wp-block-button__link has-foreground-color has-background-background-color has-text-color has-background wp-element-button" style="border-radius:9px">Lunch</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
